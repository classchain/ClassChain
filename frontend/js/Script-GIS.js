        ...
        marker.on('click', function(e) {
            ...
            if (hasTreasury) {
                financialInfo = `
                    ...
                    <div id="raisedSummary" style="margin-top:15px;"><span class="info-label">در حال خواندن مجموع واریزها...</span></div>
...
async function loadRaisedSummary(projectAttributes) {
    ...
    if (!el) return;
    el.innerHTML = '<span class="info-label">در حال خواندن مجموع واریزها از زنجیره...</span>';
    try {
        ...
        el.innerHTML = `<div class="info-item" style="background:rgba(46,204,113,0.15);padding:12px;border-radius:8px;">
            <div style="margin-bottom:4px;"><span class="info-label" style="display:block;margin-bottom:6px;">مجموع واریزها (همه شبکه‌ها)</span>
